    ...
    StepExecutionAwareInterface
{
    ...
    public function process($variantGroup)
    {
        ...
        $this->exportMedia($variantGroup, $parameters);
    ...
    /**
     * Export media in local filesystem
     *
     * @param GroupInterface $variantGroup
     * @param JobParameters  $parameters
     */
    protected function exportMedia(GroupInterface $variantGroup, JobParameters $parameters)
    {
        ...
        $this->variantGroupUpdater->setValues($variantGroup, $productTemplate->getValuesData());
